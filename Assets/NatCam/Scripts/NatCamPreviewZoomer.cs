...
namespace NatCamU {
    ...
    [RequireComponent(typeof(Graphic), typeof(RectTransform), typeof(NatCamPreviewGestures))]
    [NCDoc(20)]
    public class NatCamPreviewZoomer : NatCamPreviewBehaviour {
        ...
        [Tooltip(pinchTip)] [NCDoc(73)] public bool trackPinchGestures;
        ...
        private NatCamPreviewGestures gestures {
            get {
                if (_gestures == null) _gestures = GetComponent<NatCamPreviewGestures>();
                return _gestures;
            }
        }
        ...
        protected override void Apply () {
            ...
            isActive = true;
            gestures.trackPinchGestures = trackPinchGestures;
        ...
        public void Update () {
            if (isActive) {
                gestures.trackPinchGestures = trackPinchGestures;
                zoomRatio += trackPinchGestures ? gestures.ZoomDelta * zoomSpeed : 0;
        ...
        private const string pinchTip = "Use this to enable NatCam's default pinch-to-zoom behaviour for this NatCamPreviewZoomer.";
    }
}